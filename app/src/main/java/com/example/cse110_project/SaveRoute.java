...
public class SaveRoute {
    ...
    Button EasyPick;
    Button ModeratePick;
    Button DifficultPick;
    boolean pickedLoop = false;
    boolean pickedoutAndBack = false;
    boolean pickedFlat = false;
    boolean pickedHilly = false;
    boolean pickedStreets = false;
    boolean pickedTrail = false;
    boolean pickedEven = false;
    boolean pickedUneven = false;
    boolean pickedEasy = false;
    boolean pickedModerate = false;
    boolean pickedDifficult = false;
